    ...
    <form action="{{ route('survei.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="grid md:grid-cols-12 gap-4 mb-4">
            ...
            <div class="col-span-12 md:col-span-5">
                ...
                <input type="number" name="mitra" id="mitra" value="{{ old('mitra', $survey->mitra  ?? '1') }}" class="mt-1 block w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200" required>
            </div>
        </div>
